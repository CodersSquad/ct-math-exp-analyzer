...
- Support for balanced parenthesis `()` and brackets`[]`. Brackets have higher weight that parenthesis. So, expressions like `[(3-1)*(4+1)]`  are valid and `([3-1]*[4+1])` is invalid
- Supported operators:
  - `*` for multiplications
